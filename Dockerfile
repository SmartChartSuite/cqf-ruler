...
COPY --chown=jetty:jetty ./cqf-ruler-dstu3/target/cqf-ruler-dstu3.war /var/lib/jetty/webapps/dstu3.war
COPY --chown=jetty:jetty ./cqf-ruler-r4/target/cqf-ruler-r4.war /var/lib/jetty/webapps/r4.war
EXPOSE 8080

ENV SERVER_ADDRESS_DSTU3="https://gt-apps.hdap.gatech.edu/hdapcqfruler/dstu3/fhir"
