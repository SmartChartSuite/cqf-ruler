...
echo "r4 address: " $SERVER_ADDRESS
...
echo server_address=$SERVER_ADDRESS >> /var/lib/jetty/webapps/r4.properties
...
# set Java options
DEFAULT_OPTIONS=" -XX:+UseContainerSupport -XX:MaxRAMPercentage=80.0 -Dhapi.properties.R4=/var/lib/jetty/webapps/r4.properties"
